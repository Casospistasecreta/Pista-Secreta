      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 py-12 md:py-24">
        ...
        <div className="flex justify-center my-8 animate-in fade-in duration-1000 delay-200 fill-mode-both">
          <a
            ...
            className="bg-primary/90 hover:bg-primary text-background rounded px-8 py-4 font-serif text-lg font-bold transition-all duration-300 ease-out shadow-[0_0_20px_rgba(255,250,205,0.15)] hover:shadow-[0_0_35px_rgba(255,250,205,0.25)] hover:scale-[1.02] active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary/70 focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
